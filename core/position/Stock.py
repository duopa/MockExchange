...
from model.BasePosition import BasePosition
from utils.Constants import DefaultAccountType, OrderSide
...
class StockPosition(BasePosition):
    ...
    def apply_trade(self, trade):
        from core.structure.Trade import Trade
    ...
    @property
    def type(self):
        return DefaultAccountType.STOCK.name
    ...
    def value_percent(self):
        ...
        if DefaultAccountType.STOCK.name not in accounts:
            return 0
        total_value = accounts[DefaultAccountType.STOCK.name].total_value
    ...
    def bought_quantity(self):
        ...
        [已弃用]
        """
        user_system_log.warn("[abandon] {} is no longer valid.".format('stock_position.bought_quantity'))
        return self._quantity
    ...
    def sold_quantity(self):
        ...
        [已弃用]
        """
        user_system_log.warn("[abandon] {} is no longer valid.".format('stock_position.sold_quantity'))
        return 0
    ...
    def bought_value(self):
        ...
        [已弃用]
        """
        user_system_log.warn("[abandon] {} is no longer valid.".format('stock_position.bought_value'))
    ...
    def sold_value(self):
        ...
        [已弃用]
        """
        user_system_log.warn("[abandon] {} is no longer valid.".format('stock_position.sold_value'))
        return 0
    ...
    def average_cost(self):
        ...
        """
        user_system_log.warn("[abandon] {} is no longer valid.".format('stock_position.average_cost'))
        return self._avg_price
