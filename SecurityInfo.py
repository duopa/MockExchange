...
from utils.Constants import CommissionType, MarginType
from utils.Constants import TimeRange

TRADING_PERIOD_DICT = dict()

# | 商品期货 WR, FU, CS, C, L, V, PP, BB, FB, JD, WH, PM, RI, SF, SM, RS, JR, LR, AP
...
# | 商品期货 Y, M, A, B, P, J, JM, I, CF, SR, OI, TA, MA, ZC, FG, RM
...
# | 商品期货 CU, AL, ZN, PB, SN, NI
# | 21:01~1:00, 09:01~10:15, 10:31~11:30, 13:31~15:00 |
time_period3 = [
...
# | 商品期货 AU, AG
# | 21:01~2:30, 09:01~10:15, 10:31~11:30, 13:31~15:00 |
time_period5 = [
    TimeRange(start=time(21, 1), end=time(23, 59)),
...
CN_FUTURE_INFO = {
    ...
    "JD": {
        "hedge": {
            ...
            "commission_type": CommissionType.BY_MONEY,
